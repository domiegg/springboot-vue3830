...
public class MianshuishangpinEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public MianshuishangpinEntity() {
		
	}
	
	public MianshuishangpinEntity(T t) {
		try {
	...
	private String meizhuangmingcheng;
	private String age;
	private String sex;
	private String zige;
	 ...
	 * 设置：商品名称
	 */
	public void setMeizhuangmingcheng(String meizhuangmingcheng) {
		this.meizhuangmingcheng = meizhuangmingcheng;
	}
	/**
	 * 获取：商品名称
	 */
	public String getMeizhuangmingcheng() {
		return meizhuangmingcheng;
	}
	/**
	 * 设置：宠物分类
	 */
