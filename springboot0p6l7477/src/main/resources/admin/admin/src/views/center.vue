  ...
  <div :style='{"color":"#666","padding":"20px 30px 30px","fontSize":"16px"}'>
    ...
    >  
     <el-row>
        ...
        <el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}'   v-if="flag=='yonghu'"  label="商品" prop="shouji">
          <el-input v-model="ruleForm.shouji"               placeholder="商品" clearable></el-input>
        </el-form-item>
        ...
        <el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}'   v-if="flag=='shangjia'"  label="商家账号" prop="shangjiazhanghao">
          <el-input v-model="ruleForm.shangjiazhanghao" readonly              placeholder="商家账号" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}'   v-if="flag=='shangjia'"  label="店铺名" prop="dianpuming">
          <el-input v-model="ruleForm.dianpuming"               placeholder="店铺名" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}'   v-if="flag=='shangjia'"  label="负责人" prop="fuzeren">
        ...
        <el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-if="flag=='shangjia'" label="头像" prop="touxiang">
          <file-upload
          tip="点击上传头像"
          action="file/upload"
          :limit="3"
        ...
        <el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}'  v-if="flag=='shangjia'" label="入驻时间" prop="ruzhushijian">
            <el-date-picker
